from transpiler.optimization.pattern import recognition
from transpiler.optimization.slim import circuit_optimization
...
class optimizer():
    ...
    def slimer(self):
        ...
        example = circuit_optimization(circuit, self.slim_level)
